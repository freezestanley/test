...
/**
  * @ground ground1 - this is ground1
  * @function test1 - this is test1 function
...
function test1 () {
  /**
    * @function test2 - this is test2 function
    * @params {string} [a = A] - test params a
    * @params {string} [b = B] - test params b
    * @return {Number} [default = 111111] - test function return
    * @endfunction
  ...
  test2()
  /**
    * @function test3 - this is test2 function
    * @params {string} [a = A] - test params a
    * @params {string} [b = B] - test params b
    * @return {Number} [default = 111111] - test function return
    * @endfunction
 ...
 */
/**
  * @function test4 - this is test2 function
  * @params {string} [a = A] - test params a
  * @params {string} [b = B] - test params b
  * @return {Number} [default = 111111] - test function return
  * @endfunction
